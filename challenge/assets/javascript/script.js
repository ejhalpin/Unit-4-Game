var characters = [
  { name: "Aeris", imgSrc: "assets/images/aeris.png", playable: true, hp: 60, ap: 20, ca: 50 },
  { name: "Barret", imgSrc: "assets/images/barret.png", playable: true, hp: 125, ap: 0, ca: 15 },
  { name: "Cait-Sith", imgSrc: "assets/images/cait-sith.png", playable: true, hp: 60, ap: 20, ca: 50 },
  { name: "Gold Chocobo", imgSrc: "assets/images/chocobo-gold.png", playable: true, hp: 60, ap: 20, ca: 50 },
  { name: "Regualr Chocobo", imgSrc: "assets/images/chocobo-regular.png", playable: true, hp: 60, ap: 20, ca: 50 },
  { name: "Cid", imgSrc: "assets/images/cid.png", playable: true, hp: 60, ap: 20, ca: 50 },
  { name: "Cloud", imgSrc: "assets/images/cloud.png", playable: true, hp: 100, ap: 10, ca: 0 },
  { name: "Diamond Weapon", imgSrc: "assets/images/diamond-weapon.png", playable: true, hp: 60, ap: 20, ca: 50 },
...
function attack() {
  ...
  message.html("<p>" + selectedFighter.name + " attacked " + selectedOpponent.name + " and dealt " + fighterAP + " damage.</p>");
  ...
  message.append("<p>" + selectedOpponent.name + " counter-attacked and dealt " + opponentCA + " damage.</p>");
  fighterHpDiv.css("width", ((fighterHP / selectedFighter.hp) * 100).toString() + "%");
  //check for victory or loss
  if (opponentHP <= 0) {
    opponentCount--;
    message.append("<p>" + selectedFighter.name + " defeated " + selectedOpponent.name + "!</p>");
    ...
    message.text("Refresh to play again.");
  }
}
